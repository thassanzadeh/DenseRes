...
from devol_DR_SLIVER import DEvol
from genome_DR_SLIVER import  GenomeHandler
from metrics import *
import time
import matplotlib
matplotlib.use('Agg')
...
"""
    Load the input data and create genomes. Later, evaluate and evolve the population
    up to stated generation. Finally, the best model will be loaded for the final evaluation and
    visualisation the best and worst segmentation results.
...
def make_plots(X, y, y_pred):
    ...
    fig.savefig('best_predictionsg.png', bbox_inches='tight', dpi=300)
    ...
    fig.savefig('worst_predictionsg.png', bbox_inches='tight', dpi=300)
